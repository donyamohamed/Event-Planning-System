...
namespace Event_Planning_System.Migrations
{
    ...
    [Migration("20240714161957_addNumerofticketsColumns")]
    partial class addNumerofticketsColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Event_Planning_System.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Event_Planning_System.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EventGuest", b =>
                {
                    b.HasOne("Event_Planning_System.Enitities.Event", null)
                        .WithMany()
                        .HasForeignKey("EventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Event_Planning_System.Enitities.Guest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InterestUser", b =>
                {
                    b.HasOne("Event_Planning_System.Enitities.Interest", null)
                        .WithMany()
