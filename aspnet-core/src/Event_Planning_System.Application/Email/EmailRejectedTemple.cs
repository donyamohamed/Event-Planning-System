...
{
    public class EmailRejectedTemple
    {
        public static string YourInvitationRequestRejected(string eventName, DateTime date, string eventAddress,string guestName,string eventImg)
        {
            ...
            <body>
                <div class='poster'>
                   ...
                   <div class='message'>
                    ...
                    <p>Unfortunately, we regret to inform you that your request for an invitation has been declined.</p>
                    <p>We appreciate your understanding and hope to have the opportunity to welcome you to future events.</p>
                    <p>Best regards,</p>
