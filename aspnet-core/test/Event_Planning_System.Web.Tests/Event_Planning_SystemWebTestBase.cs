...
{
    public abstract class Event_Planning_SystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Event_Planning_SystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Event_Planning_SystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Event_Planning_SystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Event_Planning_SystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Event_Planning_SystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Event_Planning_SystemDbContext, Task<T>> func)
        {
            T result;
